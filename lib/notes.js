...
// 用「分类 + slug」唯一定位一篇笔记，避免不同分类下同名 slug 冲突。
// 文章路由为 /article/[category]/[slug]。
export const getNoteByCategorySlug = (category, slug) =>
  getAllNotes().find(note => note.category === category && note.slug === slug);
